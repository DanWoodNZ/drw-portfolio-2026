    ...
    <CaseStudyLayout>
      ...
      <HeroReveal className="w-full px-4 md:px-8 xl:px-[4%] pt-16 lg:pt-24 pb-12 lg:pb-12 flex flex-col gap-10">
        <div className="flex w-full items-center justify-between">
          <Link href="/projects/quimbee" className="group flex items-center gap-2 px-4 py-2 -ml-2 rounded-full border border-transparent hover:bg-foreground/5 transition-colors duration-200 w-fit text-foreground/70 hover:text-foreground font-semibold">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight leading-[1.2] lg:leading-[1.1] max-w-6xl">
          <span className="text-foreground/50">Case Study:</span> Quimbee Legal Education Dashboards
        </h1>
      </HeroReveal>
